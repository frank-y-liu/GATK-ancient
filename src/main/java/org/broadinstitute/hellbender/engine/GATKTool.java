...
public abstract class GATKTool extends CommandLineProgram {
     ...
     *
     * In other words, on successful runs both {@link #onTraversalSuccess} and {@link #onTraversalDone} will be called (in this order) while
     * on failed runs (when {@link #traverse} causes an exception), only {@link #onTraversalDone} will be called.
     *
